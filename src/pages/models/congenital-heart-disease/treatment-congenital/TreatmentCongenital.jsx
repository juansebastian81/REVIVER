  ...
  return (
    <>
      ...
      <div className="text-container" id="info-section">
        ...
        <p>
          La cardiopatia congenita puede abordarse mediante una combinación 
          de modificaciones en el estilo de vida, como una dieta estricta 
          tratamientos farmacológicos . La elección del tratamiento 
          dependerá de las necesidades específicas de cada paciente:
        </p>
         <h3>1. Hacer Ejercicio</h3>
        <ul>
          <li>
            hacer ejercicio es fundamental para la salud del corazón. 
            La actividad física regular fortalece el músculo cardíaco, 
            mejora la circulación sanguínea y ayuda a controlar factores 
            de riesgo como la presión arterial alta, el colesterol alto y 
            el sobrepeso, todos ellos vinculados a enfermedades cardíacas. 
          </li>
        </ul>
        ...
        <ul>
          <li>
            En defectos leves, algunos pacientes no necesitan tratamiento inmediato.
          </li>
          <li>El cardiólogo realiza controles regulares con ecocardiogramas y otros 
            estudios para monitorear la evolución.
          </li>
        </ul>

        <h3>3. Medicamentos</h3>
        <p>
          No corrigen el defecto, pero ayudan a manejar los síntomas y prevenir complicaciones:
        </p>
        <ul>
          <li>
          ...
          <li>
            <strong>IECAS o betabloqueadores:</strong> disminuyen la presión y el esfuerzo cardíaco.
          </li>
          <li>
            <strong>Inotrópicos:</strong> mejoran la fuerza del corazón.
          </li>
          <li>
            <strong>Anticoagulantes:</strong> previenen la formación de coágulos si hay riesgo.
          </li>
        </ul>
