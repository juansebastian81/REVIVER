...
import { BrowserRouter, Routes, Route } from "react-router-dom"; // ⚠️ Usa react-router-dom, no react-router
...
import Cough from "./pages/models/heart-failure/prueba/cough";
  ...
  <BrowserRouter>
    <Layout>
      <Routes>
        ...
        <Route path="/models/models/heart-failure/prueba/cough" element={<Cough />} /> {/* ✅ Ruta para tos */}
